...
- `/ai voice_chat` เปิดโหมดสนทนาด้วยเสียงกับ AI
  - สั่งเปิด/ข้าม/หยุดเพลงด้วยเสียงได้เลย เช่น *"ยูกะ เปิดเพลง ... ให้หน่อย"* -> จะเรียก `/music` ให้เอง
...
- `/transcribe` แปลงเสียงพูดในห้องเป็นข้อความแบบเรียลไทม์ (STT)
