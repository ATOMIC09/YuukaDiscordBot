<h1 align="center">🌈 YuukaDiscordBot - v1.9 "User Information Update!" ✨</h1>
<p align="center">
...
- `/youtube` ดูข้อมูลของคลิปใน Youtube รวมถึงโหลดคลิปและเสียงได้ (ยังทำงานไม่ได้)
...
- `/getchat` ใช้ดูดประวัติการแชททั้งหมดในเซิร์ฟเวอร์นั้น (ยังไม่ได้ลบ)
